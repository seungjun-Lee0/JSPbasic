...
<% 
	// 폼요소를 통채로 가져옴
	Enumeration frmlist = request.getParameterNames();
	while(frmlist.hasMoreElements()){
		String name2 = (String)frmlist.nextElement();
		String[] vals = request.getParameterValues(name2);
		for(String val : vals){
			out.println("<p>" + name2 + ":" + val + "<p>");
		}
	}
%>
<hr>
